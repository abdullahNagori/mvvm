package com.uhfsolutions.abl.location
...
//        locationDevice.add(locationArray)
    ...
    private fun generateNotification(): Notification {
        ...
        val titleText = getString(com.uhfsolutions.abl.R.string.app_name)
        ...
        return notificationCompatBuilder
            ...
            .setSmallIcon(com.uhfsolutions.abl.R.mipmap.ic_launcher_abl)
            .setDefaults(NotificationCompat.DEFAULT_ALL)
            .setOngoing(true)
            .setVisibility(NotificationCompat.VISIBILITY_PUBLIC)
            .addAction(
                com.uhfsolutions.abl.R.mipmap.ic_launcher_abl,
                getString(com.uhfsolutions.abl.R.string.launch_activity),
                activityPendingIntent
            )
            .addAction(
                com.uhfsolutions.abl.R.drawable.ic_close,
